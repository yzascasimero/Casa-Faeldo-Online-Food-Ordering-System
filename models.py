...
class Product(db.Model):
    ...
    category = db.Column(db.String(50), nullable=False)  # Main category: Food Menu, Drinks Menu, Dessert & Wine
    subcategory = db.Column(db.String(50), nullable=True)  # Subcategory within main category
